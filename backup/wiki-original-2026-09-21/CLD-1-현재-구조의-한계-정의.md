> 🚧 작성중 · 담당 미정 · 수정 2026-09-17 · 상위 [초기 배포 설계](CLD-1-초기-배포-설계) · 원본 [4-현재-구조의-한계-정의](https://github.com/100-hours-a-week/KTB4-13th-wiki/wiki/4-%ED%98%84%EC%9E%AC-%EA%B5%AC%EC%A1%B0%EC%9D%98-%ED%95%9C%EA%B3%84-%EC%A0%95%EC%9D%98)
...
---
> ✏️ 이 페이지는 레포 [docs/cld/1-initial-deploy/limits.md](https://github.com/100-hours-a-week/KTB4-13th-wiki/blob/main/docs/cld/1-initial-deploy/limits.md)에서 수정한다. 위키에서 직접 고치면 다음 반영 때 덮어써진다.
