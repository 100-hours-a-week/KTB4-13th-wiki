> 🚧 작성중 · 담당 미정 · 수정 2026-09-17 · 상위 [초기 배포 설계](CLD-1-초기-배포-설계) · 원본 [2-Docker-컨테이너-구성-설계](https://github.com/100-hours-a-week/KTB4-13th-wiki/wiki/2-Docker-%EC%BB%A8%ED%85%8C%EC%9D%B4%EB%84%88-%EA%B5%AC%EC%84%B1-%EC%84%A4%EA%B3%84)
...
---
> ✏️ 이 페이지는 레포 [docs/cld/1-initial-deploy/containers.md](https://github.com/100-hours-a-week/KTB4-13th-wiki/blob/main/docs/cld/1-initial-deploy/containers.md)에서 수정한다. 위키에서 직접 고치면 다음 반영 때 덮어써진다.
