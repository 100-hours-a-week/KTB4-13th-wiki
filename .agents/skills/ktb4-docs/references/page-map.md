...
| `2단계.-CI(지속적-통합)-파이프라인-설계.md` | 2단계. CI(지속적 통합) 파이프라인 설계 | [wiki](https://github.com/100-hours-a-week/KTB4-13th-wiki/wiki/2%EB%8B%A8%EA%B3%84.-CI%28%EC%A7%80%EC%86%8D%EC%A0%81-%ED%86%B5%ED%95%A9%29-%ED%8C%8C%EC%9D%B4%ED%94%84%EB%9D%BC%EC%9D%B8-%EC%84%A4%EA%B3%84) | CLD-2 CI 파이프라인 설계 | cld-2 | 변환됨(확인 대기) | 09-21 변환 → `docs/cld/2-ci-pipeline/overview.md`. 기술별 굵은 줄 4개를 제목으로 승격, 구분선 제거. |
